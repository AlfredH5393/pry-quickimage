    ...
    <?php
        ...
        <?php
              ...
              <div class="mx-width-1075 container-fluid mt-3 " >
                ...
                <div  class="mycards">  <!-- Inicio de estructura general de Card contenedora color blanco -->
                  <div class="content-mycards">

                    <div class="container">
                            <h4 class="text-center font-weight-bold mt-2">Subir una imagen</h4>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#nueva-imagen" @click="limpiar()">Nuevo</button>
                    </div>
                

                <div class="container">
                     <!-- Inicio de estructura generañ de Card de imagen -->
                        <div class="row" id="card-gallery" class="" style="height:355px; overflow: scroll; margin-top: 10px ">

                            <div class="col-4"> <!-- Inicio del contenedor  Card de imagen y botones -->
                                <div class="card border-primary mb-4 " style="width: 18rem;">
                                        <img class="card-img-top" src="../src/img/harleyDivison.jpg" alt="Card image cap">
                                        <div class="card-body text-center">
                                            <h5 class="card-title ">Huejutla de Reyes</h5>
                                        
                                            <div class="" style="margin-top: 1em" > 
                                                <button type="button" class="btn btn-success d-block m-auto" data-toggle="modal" data-target="#editar-imagen" >Editar</button>
                                            </div>

                                            <div class="" style="margin-top: 1em"> 
                                                <button type="button" class="btn btn-danger d-block m-auto " data-toggle="modal" data-target="#eliminar-imagen" >Eliminar</button>
                                            </div>
                                        </div>

                                        <div class="form-row m-auto ">
                                                <div class="form-group col-md-6">
                                                <input type="text" class="form-control d-block " placeholder ="Para poner Id" ></input> 
                                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body  text-center">
                                                <label for="nombre" class="col-form-label">Aqui pon todos los elementos de los modales</label>
